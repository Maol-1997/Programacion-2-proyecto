...
export class TarjetaComponent implements OnInit, OnDestroy {
  ...
  registerChangeInTarjetas() {
    this.eventSubscriber = this.eventManager.subscribe('tarjetaListModification', response => this.reset());
  }
  ...
  protected paginateTarjetas(data: ITarjeta[], headers: HttpHeaders) {
