...
describe('Compra e2e test', () => {
  ...
  it('should load Compras', async () => {
    ...
    expect(await compraComponentsPage.getTitle()).to.eq('principalApp.compra.home.title');
  });
  ...
  it('should load create Compra page', async () => {
    ...
    expect(await compraUpdatePage.getPageTitle()).to.eq('principalApp.compra.home.createOrEditLabel');
  ...
  it('should create and save Compras', async () => {
    ...
    await compraComponentsPage.clickOnCreateButton();
    await promise.all([compraUpdatePage.setPrecioInput('5'), compraUpdatePage.tarjetaSelectLastOption()]);
    expect(await compraUpdatePage.getPrecioInput()).to.eq('5', 'Expected precio value to be equals to 5');
  ...
  it('should delete last Compra', async () => {
    ...
    expect(await compraDeleteDialog.getDialogTitle()).to.eq('principalApp.compra.delete.question');
